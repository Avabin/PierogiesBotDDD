...
public interface IGuildService
{
    ...
    Task             AddDomainEventAsync(IDelivery<IEvent>    delivery,  IObservable<GuildState> stateObservable);
    Task RemoveDomainEventAsync(IDelivery<IEvent> @event, IObservable<GuildState> stateObservable);
}